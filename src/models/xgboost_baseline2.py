...
report_groups = {
    ...
    'normal_ecg': ['report_normal_ecg'],
    'borderline_ecg': ['report_borderline_ecg'],
    'abnormal_ecg': ['report_abnormal_ecg'],
    ...
    # Atrial arrhythmias
    'atrial_fib_flutter': [
        'report_atrial_fibrillation',
        'report_atrial_flutter'
    ],
    'other_atrial_rhythm': [
        'report_ectopic_atrial_rhythm'
    ],

    # Junctional rhythms
    'junctional_rhythm': [
        'report_junctional_rhythm'
    ],

    # Ventricular rhythms
    'ventricular_tachyarrhythmias': [
        'report_ventricular_tachycardia',
        'report_ventricular_bigeminy',
        'report_ventricular_trigeminy'
    ],
    'ventricular_paced': [
        'report_ventricular_paced_rhythm'
    ],

    # Supraventricular tachy
    'supraventricular_tachycardia': [
        'report_supraventricular_tachycardia'
    ],
    ...
    'ventricular_hypertrophy': [
        ...
        'report_right_ventricular_hypertrophy'
    ],
    ...
    'technical_issue': [
        ...
        'report_lead_reversal'
    ],
    'undetermined_rhythm': ['report_undetermined_rhythm']
}
...
diagnosis_groups = {
    ...
    'chronic_heart_failure': [
        'label_chronic_heart_failure'
    ],

    # Arrhythmias
    'atrial_arrhythmias': [
        'label_atrial_fibrillation_flutter'
    ],
    'ventricular_arrhythmias': [
        'label_ventricular_arrhythmias',
        'label_supraventricular_tachycardia',
        'label_premature_depolarization'
    ],
    'conduction_disorders': [
        'label_atrioventricular_block',
        'label_bradyarrhythmias_heart_block',
        'label_bundle_branch_block',
        'label_sick_sinus_syndrome'
    ],
    ...
    'chronic_ischemic': [
        'label_coronary_artery_disease',
        'label_chronic_ischemic_heart_disease',
        'label_chronic_total_occlusion'
    ],
    'angina': [
        'label_stable_angina',
        'label_unstable_angina'
    ],

    # Structural heart
    'structural_heart_disease': [
        'label_valvular_heart_disease',
        'label_cardiomyopathy',
        'label_cardiomegaly',
        'label_pericarditis_pericardial_disease',
        'label_rare_cardiac_structural',
        'label_other_heart_disease',
        'label_unspecified_cardiac'
    ],

    # Vascular
    'vascular_disease': [
        'label_aortic_disease',
        'label_peripheral_vascular_disease',
        'label_deep_vein_thrombosis',
        'label_pulmonary_embolism',
        'label_pulmonary_hypertension'
    ],

    # Stroke
    'cerebrovascular': [
        'label_ischemic_stroke',
        'label_hemorrhagic_stroke',
        'label_tia'
    ],
    ...
    'renal_disease': [
        ...
        'label_dialysis_dependence'
    ],

    # Metabolic
    'metabolic_disorders': [
        'label_diabetes_mellitus',
        'label_electrolyte_disturbance',
        'label_anemia'
    ],
    ...
    'hypertension': [
        'label_hypertension',
        'label_hypertensive_emergency'
    ],

    # Shock
    'shock_states': [
        'label_cardiogenic_shock'
    ]
}
...
def group_labels(y_df, label_groups):
    """
    Groups binary label columns into broader categories using logical OR.

    Parameters:
        y_df (pd.DataFrame): DataFrame of binary label columns (0/1)
        label_groups (dict): {new_label: [list_of_existing_labels]}

    Returns:
        pd.DataFrame: Grouped binary label DataFrame
    """
    grouped = pd.DataFrame(index=y_df.index)

    for new_label, old_labels in label_groups.items():
        existing = [col for col in old_labels if col in y_df.columns]

        if len(existing) == 0:
            grouped[new_label] = 0
        else:
            grouped[new_label] = y_df[existing].max(axis=1)
...
def prepare_model_features(model_df, ed_ecg_records, target_type='labels'):
    ...
    if target_type == 'labels' and diagnosis_groups is not None:
        y = group_labels(y, diagnosis_groups)
        y_features = list(y.columns)

    if target_type == 'reports' and report_groups is not None:
        y = group_labels(y, report_groups)
        y_features = list(y.columns)
